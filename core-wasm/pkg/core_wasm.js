...
export class Database {
    ...
    load_database(json) {
        ...
        wasm.database_load_database(this.__wbg_ptr, ptr0, len0);
    }
    /**
 ...
 * @returns {number}
 */
export function compare_hashes(hash1, hash2) {
    const ptr0 = passStringToWasm0(hash1, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(hash2, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.compare_hashes(ptr0, len0, ptr1, len1);
    return ret >>> 0;
}
 ...
 * @returns {string}
 */
export function get_phash(data) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_phash(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
 ...
 * @returns {string}
 */
export function get_phash_raw(rgba, width, height) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passArray8ToWasm0(rgba, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.get_phash_raw(ptr0, len0, width, height);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
